...
MainContentComponent::MainContentComponent()
{
    ...
    setAudioChannels (128, 128, savedAudioState.get());
...
void MainContentComponent::exportWav (AudioSampleBuffer& bufferToWrite, String fileName)
{
    ...
    ScopedPointer<AudioFormatWriter> writer (wavFormat.createWriterFor (fos.get(), sampleRate, numChannel, bitDepth, StringPairArray(), 0));
    fos.release();
...
void MainContentComponent::showAudioSettings()
{
    AudioDeviceSelectorComponent audioSettingsComp (deviceManager,
                                                    0,
                                                    128, //InputChannels: min/max
                                                    0,
                                                    128,   //OutputChannels: min/max
